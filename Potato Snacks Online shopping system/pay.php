				...
				<form action="process.php" method="POST" id="paymentForm">	
					<div class="row">
						<div class="col-md-8" style="border-right:1px solid #ddd;">
							...
							<input type="button" name="payNow" id="payNow" class="btn btn-success btn-sm" onclick="save_transaction(event)" value="Pay Now" />
							</div>
							<br>
						</div>
						<div class="col-md-4">
...
<script>
	function save_transaction(){		
		...
		$.ajax({
			...
			method:'POST',
			data:{odestats:odrstatus,card_number:'<?php echo number_format($total,2) ?>',id:'<?php echo $_GET['id'] ?>'},
			dataType: 'json',
