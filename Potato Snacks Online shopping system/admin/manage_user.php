	...
	<form action="" id="manage-user">
		...
		<div class="form-group">
			...
			<select name="type" id="type" class="custom-select">
				<option value="1" <?php echo isset($meta['type']) && $meta['type'] == 1 ? 'selected': '' ?>>ผู้ดูแลระบบ</option>
				<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected': '' ?>>ผู้ช่วย</option>
			</select>
		</div>
	</form>
</div>
